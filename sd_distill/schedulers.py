...
class ReflowScheduler(SchedulerMixin, ConfigMixin):
    ...
    def step(
        ...
        if not self.distill:
            ...
            pred_original_sample = (
                sample + (1 - t / self.num_train_timesteps) * model_output
            )
        else:
    ...
    def previous_timestep(self, timestep):
        if self.custom_timesteps:
            ...
            num_inference_steps = (
                self.num_inference_steps or self.config.num_train_timesteps
            )
