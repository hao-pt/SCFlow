...
class TimestepEmbedding(nn.Module):
    def __init__(self, embedding_dim, hidden_dim, output_dim, act="lrelu"):
        super().__init__()
    ...
    def forward(self, temp):
        temb = timestep_embedding(temp, self.embedding_dim)
        temb = self.main(temb)
        return temb
...
#     block_kwargs = {'resample_filter': [1,1], 'init': init}
#     epilogue_kwargs = {'init': init}
#     return Discriminator(block_kwargs=block_kwargs, epilogue_kwargs=epilogue_kwargs, **kwargs)


# def song_discriminator(**kwargs):
#     init = dict(init_mode='xavier_uniform')
#     block_kwargs = {'resample_filter': [1,3,3,1], 'init': init}
#     epilogue_kwargs = {'init': init}
#     return Discriminator(block_kwargs=block_kwargs, epilogue_kwargs=epilogue_kwargs, **kwargs)


# def ddpm_discriminator(**kwargs):
#     init = dict(init_mode='xavier_uniform')
#     block_kwargs = {'resample_filter': [1,1], 'init': init}
#     epilogue_kwargs = {'init': init}
#     return Discriminator(block_kwargs=block_kwargs, epilogue_kwargs=epilogue_kwargs, **kwargs)
