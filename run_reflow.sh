#!/bin/sh
#SBATCH --job-name=cdonly # create a short name for your job
...
python train_consistent_flow_distill.py \
	--exp celeb_adm_threshold1e-1_trunc4e-1_cdonly \
	--init_threshold 0.1 \
	--trunc_threshold 0.4 \
	--dataset celeba_256 \
	...
	--warm_up_reflow 1_000_000 \
	--warm_up_gan 1_000_000 \
	--warm_up_inverse 1_000_000 \
	--num_epoch 200 \
