...
###################################
slurm_file_path = f"/lustre/scratch/client/vinai/users/haopt12/flow_distill/slurm_scripts/{exp}/run.sh"
slurm_output = f"/lustre/scratch/client/vinai/users/haopt12/flow_distill/slurm_scripts/{exp}/"
