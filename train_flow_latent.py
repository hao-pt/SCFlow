        ...
        for iteration, (x, y) in enumerate(data_loader):
            ...
            if iteration % 100 == 0:
                if rank == 0:
                    ...
                    logger.info('epoch {} iteration{}, Loss: {}, LossG: {}, LossD: {}, Train Steps/Sec: {:.2f}'.format(epoch, iteration, loss.item(), Gloss.item(), Dloss.item(), steps_per_sec))
                    start_time = time()
